...
### Overview
SHOPBYAISLE : Yes, you heard it right!! ShopByAisle Web Application is what I Intend to work upon to make shopping experience for users like me, a speedy process.
...
### Features
1. User Signup/Login - Users will be able to create accounts and log    in to the application. Each user will have a profile page.
2. Store Locator – Users will be able to search stores nearby and add to their favorite List of stores.
3. Add Shopping List- Users will be able to create their own shopping list.
4. Add Aisle Feature- Allows users to add Aisle based on their shopping experience, which can be shared across users.
### Technologies
1. C# MVC
2. ASP.Net
3. Javascript
...
1. How to use Google maps API for store locator feature.
2. BootStrap (And much more...)
### Project Tracker
https://trello.com/b/M9VJBZHX/shopbyaisle-project	
